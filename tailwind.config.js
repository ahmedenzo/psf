...
const config = {
    ...
    theme      : {
        ...
        extend  : {
              keyframes: {
    bar1: {
      '0%, 100%': { height: '20px', y: '60' },
      '50%': { height: '30px', y: '50' },
    },
    bar2: {
      '0%, 100%': { height: '30px', y: '50' },
      '50%': { height: '20px', y: '60' },
    },
    bar3: {
      '0%, 100%': { height: '40px', y: '40' },
      '50%': { height: '30px', y: '50' },
    },
    line: {
      '0%, 100%': { stroke: '#ffffff' },
      '50%': { stroke: '#a5b4fc' }, // indigo-200
    },
  },
  animation: {
    bar1: 'bar1 2s ease-in-out infinite',
    bar2: 'bar2 2s ease-in-out infinite',
    bar3: 'bar3 2s ease-in-out infinite',
